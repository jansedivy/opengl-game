...
set Includes=/I ..\..\libs\glm /I ..\..\libs\windows\glew\include /I ..\..\libs\assimp\include

set EngineLibs=/I ..\..\libs\windows\SDL2\include /I ..\..\libs\windows\dirent ..\..\libs\windows\SDL2\lib\x64\SDL2main.lib ..\..\libs\windows\SDL2\lib\x64\SDL2.lib
